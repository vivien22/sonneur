...
var bccMails = 'bibien22@hotmail.com, djerem+roc14@djerem.net';
...
function createFirstCallMessage(date, timeSlot)
{
  ...
  return Message = 
  {
    ...
    + '(' + date + ').' + 
    '</span><br><br>' +
    '<span style="font-size:12.8px">Je rappelle le </span>' +
    '<a href="' + refLinkCal + '" rel="noreferrer" target="_blank" style="font-size:12.8px">' + 'lien vers le classeur' + '</a>' +  ' à remplir.' +
    '<br><br>' +
...
function createCancellationMessage(date, timeSlot)
{
  ...
  return Message = 
  {
    ...
    + '(' + date + ').' + 
    '</span><br><br>' +
    '<a href="' + refLinkCal + '" rel="noreferrer" target="_blank" style="font-size:12.8px">' + 'L&#39;annulation du créneau s&#39;impose ?' + '</a>' +
    '<br><br>' +
